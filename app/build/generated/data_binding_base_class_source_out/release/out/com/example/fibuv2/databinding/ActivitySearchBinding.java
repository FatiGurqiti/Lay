...
public final class ActivitySearchBinding implements ViewBinding {
  ...
  public static ActivitySearchBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ImageView BlackFilterInSearch2 = rootView.findViewById(id);
      ...
      ImageView notFoundImage = rootView.findViewById(id);
      ...
      ProgressBar progressBarInSearch2 = rootView.findViewById(id);
      ...
      TextView secondTextReference = rootView.findViewById(id);
