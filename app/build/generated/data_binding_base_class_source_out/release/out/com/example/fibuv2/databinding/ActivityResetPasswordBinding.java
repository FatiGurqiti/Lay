...
public final class ActivityResetPasswordBinding implements ViewBinding {
  ...
  public static ActivityResetPasswordBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      EditText passwordreset = rootView.findViewById(id);
      if (passwordreset == null) {
        break missingId;
      }

      id = R.id.resetprogressBar;
      ProgressBar resetprogressBar = rootView.findViewById(id);
      if (resetprogressBar == null) {
        break missingId;
      }

      id = R.id.restetaftertext;
      TextView restetaftertext = rootView.findViewById(id);
      if (restetaftertext == null) {
        break missingId;
      }

      id = R.id.restetresetbtn;
      Button restetresetbtn = rootView.findViewById(id);
      if (restetresetbtn == null) {
        break missingId;
      }

      id = R.id.restettextView;
      TextView restettextView = rootView.findViewById(id);
